...
function Sidebar() {
  ...
  return (
    <>
    <div className='m-3 position-fixed w-30'>

      <div className='d-flex flex-column gap-3'>
        <img className='logo-text ' src="db/assets/instagram-text-icon.webp" alt="" />
        ...
        <div onClick={()=>(navigate('/profile'))}><i className="bi bi-person-circle profile"></i>Profile</div>
      </div>
